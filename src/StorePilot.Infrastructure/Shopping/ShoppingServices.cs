...
namespace StorePilot.Infrastructure.Shopping;

public sealed class ShoppingQueries(StorePilotDbContext db, IOptions<ShoppingOptions> options) : IShoppingQueries
{
...
{
    public static async Task<int> RebuildAsync(StorePilotDbContext db, int perCustomer, ILogger logger, CancellationToken ct)
    {
