...
public static class DemoSeeder
{
    ...
    public static async Task SeedAsync(StorePilotDbContext db, CancellationToken ct = default)
    {
    ...
    /// </summary>
    public static async Task SeedPodDataAsync(StorePilotDbContext db, CancellationToken ct = default)
    {
