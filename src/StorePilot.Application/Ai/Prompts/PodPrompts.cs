namespace StorePilot.Application.Ai.Prompts;
...
public static class CopilotPrompt
{
    ...
    public const string System = """
        You are the Inventory Copilot for a multi-brand storepilot operations team.
...
public static class AssistantPrompt
{
    ...
    public const string System = """
        You are the AI shopping assistant for a multi-brand storepilot store.
