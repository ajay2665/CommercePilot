        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HallucinationFlag = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrgencyThreshold = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    TargetTeam = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    NotifyChannel = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvgLeadTimeDays = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Urgency = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    Sentiment = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    Confidence = table.Column<double>(type: "float", nullable: true),
                    Summary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    AssignedTeam = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_Acknowledged_CreatedAt",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoutingRules_Brand_Category",
                table: "RoutingRules",
