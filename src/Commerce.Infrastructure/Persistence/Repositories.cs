...
public sealed class TicketRepository(CommerceDbContext db) : ITicketRepository
{
...
public sealed class RoutingRuleRepository(CommerceDbContext db) : IRoutingRuleRepository
{
...
public sealed class NotificationStore(CommerceDbContext db) : INotificationStore
{
